...
pub(crate) fn register_all() -> Vec<Box<dyn Tool>> {
    vec![
        ...
        Box::new(convert::base32::Base32Tool::default()),
        ...
        Box::new(convert::byte_size::ByteSizeTool::default()),
        Box::new(convert::duration::DurationTool::default()),
        ...
        Box::new(text::slug::SlugTool::default()),
        Box::new(text::escape::EscapeTool::default()),
        Box::new(web::jwt_decode::JwtDecodeTool::default()),
        Box::new(web::jwt_encode::JwtEncodeTool::default()),
        ...
        Box::new(web::http_status::HttpStatusTool::default()),
    ]
}
